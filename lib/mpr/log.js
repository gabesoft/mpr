...
var util   = require('./util')
  ...
  , logln = function(label, color, data) {
        console.log(label[color] + ' ' + data + ' ' + '¬'[color]);
    };
...
Log.prototype.stop = function(proc, status) {
    // TODO: use log.info(text, vertical-pad-before, vertical-pad-after)
    //
    switch(status) {
        case 'not-found':
            //log.error('A process with the specified id or name was not found.', 2, 2);
            console.log('error'.red + ':');
            console.log('error'.red + ':');
            console.log('error'.red + ':' + pad + 'A process with the specified id or name was not found.');
            console.log('error'.red + ':');
            console.log('error'.red + ':');
            break;
        case 'not-running':
            ...
            console.log('warn'.yellow + ':');
            console.log('warn'.yellow + ':' + pad + 'Process ' + proc.name.blue  + ' is not running.');
            console.log('warn'.yellow + ':');
            console.log('warn'.yellow + ':');
            break;
        case 'success':
            ...
            console.log('info'.green + ':');
            console.log('info'.green + ':' + pad + 'Process ' + proc.name.blue + ' was sent the kill signal.');
            console.log('info'.green + ':');
            console.log('info'.green + ':');
            break;
        default:
            ...
            console.log('error'.red.inverse + ':');
            console.log('error'.red.inverse + ':' + pad + 'Unknown status.');
            console.log('error'.red.inverse + ':');
            console.log('error'.red.inverse + ':');
    }
};
